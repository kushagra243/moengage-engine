...
PERSONAS: Dict[str, Dict[str, Any]] = {
    ...
    "alerts": dict(name="Market Alerts 2.0 agent", emoji="◬", purpose="analysis", skills=["market-alerts-2", "crypto-compliance-copy", "crypto-derivatives-marketing"],
        ...
        tools=READ_COMMON + ["market_alerts_dry_run", "market_alerts_propose_pilot", "compliance_sweep", "request_data", "comment_proposal", "record_ideas"],
