...
ENGINE_SETTINGS: Dict[str, Dict[str, Any]] = {
    ...
    "market_coinglass_api_key": {"type": "str", "max_len": 120, "help": "optional Coinglass key (free tier) for cross-exchange OI / funding / liquidations by venue — stored encrypted"},
