...
PRODUCTS: Dict[str, Dict[str, Any]] = {
    ...
    "perps_indices": dict(name="Index perps", codes=["IDX", "INDEX", "INDICES", "SPX", "NDX", "SP500", "NASDAQ"], pillars=["macro calendar", "24/7 hedging education"], lens="index move + macro context; hedge/risk tools", never=["direction"], cadence="≤ 2 push / week", cross_sell=["US stocks"]),
    ...
    "options":     dict(name="Options", codes=["OPT", "OPTIONS", "OPTION", "CALL", "PUT", "STRADDLE"], pillars=["defined-risk education", "expiry calendar", "greeks basics"], lens="expiry / IV context as education; max-loss framing; no strategy recommendation", never=["strategy tips", "'cheap premium' lures"], cadence="≤ 2 touches / week; expiry-day notes", cross_sell=["perps risk tools"]),
