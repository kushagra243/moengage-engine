...
WRITE_STRATEGY = ["propose_campaign", "propose_segment", "propose_flow", "propose_pause_campaign", "run_sop", "campaign_from_alert", "record_ideas", "request_data", "write_flight_plan", "revise_proposal", "comment_proposal", "propose_signal_rule", "market_alerts_propose_pilot", "propose_skill_update", "propose_sop_change", "request_sop", "draft_sop"]
