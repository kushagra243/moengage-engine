...
LEAKS = [
    ...
    (re.compile(r"\b(create_segment|create_campaign|create_flow|pause_campaign|code_change|custom_segment_upload|signal_rule|skill_update|sop_change|sop_new|ma2_pilot|ma2_discovery|alert_send|test_send|telegram_post)\b"),
     lambda m: {"create_segment": "a new cohort", "create_campaign": "a campaign draft", "create_flow": "a flow draft", "pause_campaign": "pausing a campaign", "code_change": "an engine change",
                ...
                "ma2_pilot": "the alerts pilot", "ma2_discovery": "the market alerts programme", "alert_send": "a market alert", "test_send": "a test send", "telegram_post": "a community post"}[m.group(1)]),
...
def _proposal_decision(d: Dict[str, Any]) -> Dict[str, Any]:
    ...
    verb, title, primary = {
        ...
        "telegram_post": ("post", f"Post to the community channel: “{str(pl.get('text', ''))[:50]}…”", "POST IT"),
