...
TOOL_BUDGETS = {"list_campaigns": 6000, "campaign_taxonomy": 6000, "segment_study": 7000, "anomaly_report": 6000, "market_snapshot": 5000, "market_news": 3500, "market_campaign_hooks": 4500,
                "growth_hacks": 4000, "list_proposals": 3500, "moengage_api_reference": 5000, "skill": 9000, "sentiment_pushes": 6000, "moengage_guidance": 4000, "campaign_deep_dive": 7000, "flight_plans": 6000,
                "sop_detail": 5000, "list_sops": 3000, "experiment_readouts": 4000, "peace_index": 4000, "self_diagnose": 6000, "market_alerts_status": 5000, "market_alerts_rules": 5000, "market_alerts_dry_run": 4500, "market_alerts_discovery": 5000, "market_alerts_brief": 9000}
...
15c. Ask, do not guess. When a fact only the team has is missing (what a cohort name means, the KPI name here, whether a product is live in a region, the cap to use), call ask_operator, then continue on a stated assumption. The answer comes back as guidance in every later conversation.
...
27. Never describe an internal process from memory. ask_sops first and cite the SOP (`sop_id § section`); sop_ownership answers who owns the next step and who to contact when blocked. If the library does not cover it, say so and propose the SOP instead of inventing one.
