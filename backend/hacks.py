...
LIBRARY: List[Dict[str, Any]] = [
    ...
    dict(id="tokenised_after_hours", title="'Markets that never close' — tokenised equities after US hours", category="activation",
         ...
         how="Hook mover_equities → segment 'watchlist contains symbol OR traded any builder dex' → push at 08:00 or 18:00 IST with the move and 'on Hyperliquid' wording; product_education angle; never 'trade earnings'.",
