...
READ_COMMON = ["log_challenge", "sentiment_pushes", "list_campaigns", "campaign_content", "segment_detail", "campaign_history", "campaign_taxonomy", "clm_program_audit", "rule_based_audit", "anomaly_report", "campaign_diagnosis", "campaign_deep_dive", "segment_study",
